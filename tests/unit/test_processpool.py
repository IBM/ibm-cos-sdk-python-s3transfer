...
from ibm_s3transfer.processpool import SHUTDOWN_SIGNAL
from ibm_s3transfer.processpool import ignore_ctrl_c
from ibm_s3transfer.processpool import DownloadFileRequest
from ibm_s3transfer.processpool import GetObjectJob
from ibm_s3transfer.processpool import ProcessTransferConfig
from ibm_s3transfer.processpool import ProcessPoolDownloader
from ibm_s3transfer.processpool import ProcessPoolTransferFuture
from ibm_s3transfer.processpool import ProcessPoolTransferMeta
from ibm_s3transfer.processpool import TransferMonitor
from ibm_s3transfer.processpool import TransferState
from ibm_s3transfer.processpool import ClientFactory
from ibm_s3transfer.processpool import GetObjectSubmitter
from ibm_s3transfer.processpool import GetObjectWorker
...
class TestProcessPoolDownloader(unittest.TestCase):
    def test_uses_client_kwargs(self):
        with mock.patch('ibm_s3transfer.processpool.ClientFactory') as factory:
